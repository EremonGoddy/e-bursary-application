      ...
      <div className="container my-5" style={{ backgroundColor: "white"}}>
        <div className="row text-center">
          <div className="col-md-4">
            ...
            <p style={{ fontSize:"1.3rem", color: "#555"}}>Nawoitorong, Turkana County Headquarters<br />P.O Box 141-30500, Lodwar</p>
          </div>
          <div className="col-md-4">
        ...
        <div className="row d-flex align-items-center">
          <div className="col-md-6 text-center">
            ...
            <p style={{ fontSize:"1.3rem"}}>
              Have questions or need assistance? We're here to help! Whether you’re seeking information, need support,
          ...
          <div className="col-md-6" style={{ backgroundColor: "white", boxShadow: "0 0 0.8rem rgba(0,0,0,0.8)", borderRadius: "8px", padding: "30px"}}>
