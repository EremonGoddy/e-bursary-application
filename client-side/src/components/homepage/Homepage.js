...
import arrangement from "../../image/arrangement-education-growth-concept.jpg";
import homepic from "../../image/homepic.jpg";
import homephoto from "../../image/homephoto.jpg";
import "./Homepage.css";

const Homepage = () => {
  const images = [arrangement, homepic, homephoto];
        ...
        <div className="carousel-inner">
          {images.map((image, index) => (
            ...
            >
              ...
              />
              <div
                className="blur position-absolute bottom-0 w-100 text-white text-center "
